			...
			<Container left={0} right={0} top={0} bottom={0}>
				<Canvas
					...
					paint={(g) => {
						...
						// ---- HERO time: HH:MM:SS all ONE size (49px), one baseline — HH:MM
						//      white, :SS the same size in quiet gray. "22:31:46" (~190px) fits
						//      the round content-safe band centered at the wide middle. ----
						const yt = cy - 28;
						g.text(TWO(d.getHours()) + ":" + TWO(d.getMinutes()), g49, "white", cx - 96, yt);
						g.text(":" + TWO(s), g49, "#aaaaaa", cx + 26, yt);
