// ONE-module counterpart of lazyfat: the SAME ~40KB of code but as a
// SINGLE lazy module — measures the single-module load ceiling.
	...
	<Container left={0} right={0} top={0} bottom={0} focus={true}
		...
		<Column>
			<Navigator root={(nav: any) => { NAV = nav; return (
				<Column>
					<Label string="lazyone: 1x40KB" />
					<Label string="select = load it" />
				</Column>
			); }} />
		</Column>
	</Container>
