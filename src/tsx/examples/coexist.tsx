// #44 — hand-written Piu and pebble-signals JSX in the SAME app, at the same
// time, both live. The point: adopting pebble-signals is not all-or-nothing.
...
//                  reactive update — pebble-signals's path);
...
// --- pebble-signals half: a reactive JSX binding -------------------------------
